  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return GridView.builder(
        ...
        itemCount: myHomeController.myFavorious.length,
        itemBuilder: (context, index) {
          final product = myHomeController.myFavorious[index];
